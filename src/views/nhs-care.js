...
const NHSCare = (props) => {
  return (
    <div className="nhs-care-container1">
      <Helmet>
        <title>NHS-Care - Jameella</title>
        <meta
          name="description"
        ...
        />
        <meta property="og:title" content="NHS-Care - Jameella" />
        <meta
      ...
      <header data-role="Header" className="nhs-care-header">
        <div className="nhs-care-container2">
          <div className="nhs-care-nav">
            <NavigationLinks rootClassName="rootClassName16"></NavigationLinks>
          </div>
        </div>
        <div className="nhs-care-btn-group">
          <a
            href="mailto:jameella@me.com?subject=Enquiry: "
            className="nhs-care-link1 button"
          >
            Get in touch
          </a>
        </div>
      </header>
      <div className="nhs-care-hero">
        <div className="nhs-care-container3">
          <h1 className="nhs-care-text10">NHS / Care</h1>
          <span className="nhs-care-text11">
        ...
        <img
          ...
          className="nhs-care-image1"
        />
        <img
          alt="image"
          src="/portfolio-images/nhs/desktop%20-%201-1500h.png"
          className="nhs-care-image2"
        />
        <span className="nhs-care-text12">
          The UX research conducted for these applications involved:
        </span>
        <ul className="nhs-care-ul list">
          <li className="nhs-care-li1 list-item">
            <span>
          ...
          <li className="nhs-care-li2 list-item">
            <span>
              <span>
          ...
          <li className="nhs-care-li3 list-item">
            <span>
              <span>
          ...
          <li className="nhs-care-li4 list-item">
            <span>
              <span>
          ...
          <li className="nhs-care-li5 list-item">
            <span>
              <span>
        ...
        <div className="nhs-care-container4">
          <img
            alt="image"
            src="/portfolio-images/nhs/nhs_phone_03%402x-400w.png"
            className="nhs-care-image3"
          />
          <img
            alt="image"
            src="/portfolio-images/nhs/iphone%2011%20pro%20max%20-%201-400w.png"
            className="nhs-care-image4"
          />
        </div>
        <div className="nhs-care-banner">
          <h2 className="nhs-care-text26">
          ...
          <a
            href="mailto:jameella@me.com?subject=Enquiry:"
            className="nhs-care-link2 button"
          >
            Get in touch
          </a>
          <HomeLinkButton rootClassName="home-link-buttonroot-class-name"></HomeLinkButton>
        </div>
      </div>
      <footer className="nhs-care-footer">
        <span className="nhs-care-text27">
          © 2023 Jameella, All Rights Reserved.
        </span>
        <div className="nhs-care-icon-group">
          <a
            href="https://links.jameella.com/linkedin"
            target="_blank"
            rel="noreferrer noopener"
            className="nhs-care-link3"
          >
            <svg
              viewBox="0 0 877.7142857142857 1024"
              className="nhs-care-icon1"
            >
